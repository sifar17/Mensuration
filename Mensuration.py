...
class Square:
    ...
    def area(args):
        ...
        Claculate the Area of a Sqaure with given side.
        :param args: Side.
    ...
    def perimeter(args):
        ...
        Claculate the Perimeter of a Sqaure with given side.
        :param args: Side.
        :type args: int or float or iterable of Side.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
...
class Rectangle:
    ...
    def area(*args):
        ...
        Claculate the Area of a Rectangle with given Length & Breadth.
    ...
    def perimeter(*args):
        ...
        Claculate the Perimeter of a Rectangle with given Length & Breadth.
        :param args: Length & Breadth.
        :type args: int or float or iterable of Length & Breadth.
        :e.g.: (2, 3) or (2.0, 3.1) or ([(2, 3.0), {3.1, 4.2}, [1, 2.2]])
...
class Rhombus:
    ...
    def area(*args):
        ...
        Claculate the Area of a Rhombus with given diagonals.
    ...
    def perimeter(args):
        ...
        Claculate the Perimeter of a Rhombus with given diagonals.
        :param args: Side.
        :type args: int or float or iterable of Side.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
...
class Parallelogram:
    ...
    def area(*args):
        ...
        Claculate the Area of a Parallelogram with given Base & Height.
    ...
    def perimeter(*args):
        ...
        Claculate the Perimeter of a Parallelogram with given Length & Breadth.
        :param args: Length & Breadth.
        :type args: int or float or iterable of Length & Breadth.
        :e.g.: (2, 3) or (2.0, 3.1) or ([(2, 3.0), {3.1, 4.2}, [1, 2.2]])
...
class Trapezium:
    ...
    def area(*args):
        ...
        Claculate the Area of a Trapezium with given Two parallel sides & height.
    ...
    def perimeter(*args):
        ...
        Claculate the Perimeter of a Trapezium with given 4 sides (a, b, c, d).
...
class Circle:
    ...
    def area(args):
        ...
        Claculate the Area of a Circle with given radius.
        :param args: radius.
    ...
    def perimeter(args):
        ...
        Claculate the Perimeter of a Circle with given radius.
        :param args: radius.
        :type args: int or float or iterable of radius.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
...
class SemiCircle:
    ...
    def area(args):
        ...
        Claculate the Area of a Semi-Circle with given radius.
        :param args: radius.
        :type args: int or float or iterable of radius.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
    ...
    def perimeter(args):
        ...
        Claculate the Perimeter of a Semi-Circle with given radius.
        :param args: radius.
        :type args: int or float or iterable of radius.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
...
class ScaleneTriangle:
    ...
    def area(*args):
        ...
        Claculate the Area of a Scalene Triangle with given sides (a, b, c).
    ...
    def perimeter(*args):
        ...
        Claculate the Perimeter of a Scalene Triangle with given sides (a, b, c).
        :param args: sides (a, b, c).
        :type args: int or float or iterable of sides (a, b, c).
        :e.g.: (2, 3, 5) or (2.0, 3.1, 5) or ([(2, 3.0, 5), {3.1, 4.2, 7}, [1, 2.2, 4.3]])
...
class IsoscelesTriangle:
    ...
    def area(*args):
        ...
        Claculate the Area of a Isosceles Triangle with given base & height.
        :param args: base & height.
        :type args: int or float or iterable of base & height.
        :e.g.: (2, 3) or (2.0, 3.1) or ([(2, 3.0), {3.1, 4.2}, [1, 2.2]])        
    ...
    def perimeter(*args):
        ...
        Claculate the Perimeter of a Isosceles Triangle with given One of equal side (a) & base.
...
class EquilateralTriangle:
    ...
    def area(args):
        ...
        Claculate the Area of a Equilateral Triangle with given side.
        :param args: side.
        :type args: int or float or iterable of side.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
    ...
    def perimeter(args):
        ...
        Claculate the Perimeter of a Equilateral Triangle with given side.
        :param args: side.
        :type args: int or float or iterable of side.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
...
class RightAngleTriangle:
    ...
    def area(*args):
        ...
        Claculate the Area of a Right-Angle Triangle with given base & height.
        :param args: base & height.
        :type args: int or float or iterable of base & height.
        :e.g.: (2, 3) or (2.0, 3.1) or ([(2, 3.0), {3.1, 4.2}, [1, 2.2]])
    ...
    def perimeter(*args):
        ...
        Claculate the Perimeter of a Right-Angle Triangle with given
        sides (a, b, c).
        :param args: sides (a, b, c).
        :type args: int or float or iterable of sides (a, b, c).
        :e.g.: (2, 3, 5) or (2.0, 3.1, 5) or ([(2, 3.0, 5), {3.1, 4.2, 7}, [1, 2.2, 4.3]])
...
class Cube:
    ...
    def volume(args):
        ...
        Claculate the Volume of a Cube with given side.
        :param args: Side.
        :type args: int or float or iterable of Side.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
    ...
    def curvedSurfaceArea(args):
        ...
        Claculate the Curved Surface Area of a Cube with given side.
        :param args: Side.
        :type args: int or float or iterable of Side.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
    ...
    def totalSurfaceArea(args):
        ...
        Claculate the Total Surface Area of a Cube with given side.
        :param args: Side.
        :type args: int or float or iterable of Side.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
...
class Cuboid:
    ...
    def volume(*args):
        ...
        Claculate the Volume of a Cuboid with given Length, Breadth & Height.
    ...
    def curvedSurfaceArea(*args):
        ...
        Claculate the Curved Surface Area of a Cuboid with given Length, Breadth & Height.
        :param args: Length, Breadth & Height.
        :type args: int or float or iterable of Length, Breadth & Height.
        :Order: Length, Breadth, Height 
        :e.g.: (2, 3, 5) or (2.0, 3.1, 5) or ([(2, 3.0, 5), {3.1, 4.2, 7}, [1, 2.2, 4.3]])
    ...
    def totalSurfaceArea(*args):
        ...
        Claculate the Total Surface Area of a Cuboid with given Length, Breadth & Height.
        :param args: Length, Breadth & Height.
        :type args: int or float or iterable of Length, Breadth & Height.
        :Order: Length, Breadth, Height 
        :e.g.: (2, 3, 5) or (2.0, 3.1, 5) or ([(2, 3.0, 5), {3.1, 4.2, 7}, [1, 2.2, 4.3]])
...
class Sphere:
    ...
    def volume(args):
        ...
        Claculate the Volume of a Sphere with given Radius.
        :param args: Radius.
        :type args: int or float or iterable of Radius.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
    ...
    def curvedSurfaceArea(args):
        ...
        Claculate the Curved Surface Area of a Sphere with given Radius.
        :param args: Radius.
        :type args: int or float or iterable of Radius.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
...
class HemiSphere:
    ...
    def volume(args):
        ...
        Claculate the Volume of a Hemisphere with given Radius.
        :param args: Radius.
        :type args: int or float or iterable of Radius.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
    ...
    def curvedSurfaceArea(args):
        ...
        Claculate the Curved Surface Area of a Hemisphere with given Radius.
        :param args: Radius.
        :type args: int or float or iterable of Radius.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
    ...
    def totalSurfaceArea(args):
        ...
        Claculate the Total Surface Area of a Hemisphere with given Radius.
        :param args: Radius.
        :type args: int or float or iterable of Radius.
        :e.g.: (2) or (2.0) or ((2, 3.0, 4))
...
class Cylinder:
    ...
    def volume(*args):
        ...
        Claculate the Volume of a Cylinder with given Radius & Height.
    ...
    def curvedSurfaceArea(*args):
        ...
        Claculate the Curved Surface Area of a Cylinder with given Radius & Height.
        :param args: Radius & Height.
        :type args: int or float or iterable of Radius & Height.
        :e.g.: (2, 3) or (2.0, 3.1) or ([(2, 3.0), {3.1, 4.2}, [1, 2.2]])
    ...
    def totalSurfaceArea(*args):
        ...
        Claculate the Total Surface Area of a Cylinder with given Radius & Height.
        :param args: Radius & Height.
        :type args: int or float or iterable of Radius & Height.
        :Order: Radius, Height        
        :e.g.: (2, 3) or (2.0, 3.1) or ([(2, 3.0), {3.1, 4.2}, [1, 2.2]])
...
class Cone:
    ...
    def volume(*args):
        ...
        Claculate the Volume of a Cone with given Radius & Height.
        :param args: Radius & Height.
        :type args: int or float or iterable of Radius & Height.
        :e.g.: (2, 3) or (2.0, 3.1) or ([(2, 3.0), {3.1, 4.2}, [1, 2.2]])
    ...
    def curvedSurfaceArea_withSlantHeight(*args):
        ...
        Claculate the Curved Surface Area of a Cone with given Radius & Slant Height.
    ...
    def curvedSurfaceArea_withHeight(*args):
        ...
        Claculate the Curved Surface Area of a Cone with given Radius & Height.
        :param args: Radius & Height.
        :type args: int or float or iterable of Radius & Height.
        :Order: Radius, Height
        :e.g.: (2, 3) or (2.0, 3.1) or ([(2, 3.0), {3.1, 4.2}, [1, 2.2]])
    ...
    def totalSurfaceArea(*args):
        ...
        Claculate the Total Surface Area of a Cone with given Radius & Slant Height.
        :param args: Radius & Slant Height.
        :type args: int or float or iterable of Radius & Slant Height.
    ...
    def slantHeight(*args):
        ...
        Claculate the Slant Height of a Cone with given Radius & Height.
        :param args: Radius & Height.
        :type args: int or float or iterable of Radius & Height.
        :e.g.: (2, 3) or (2.0, 3.1) or ([(2, 3.0), {3.1, 4.2}, [1, 2.2]])
...
class Frustum:
    ...
    def volume(*args):
        ...
        Claculate the Volume of a Frustum with given Inner Radius, Outer Radius & Height.
    ...
    def curvedSurfaceArea_withSlantHeight(*args):
        ...
        Claculate the Curved Surface Area of a Frustum with given Inner Radius, Outer Radius & Slant Height.
    ...
    def curvedSurfaceArea_withHeight(*args):
        ...
        Claculate the Curved Surface Area of a Frustum with given Inner Radius, Outer Radius & Height.
        :param args: Inner Radius, Outer Radius & Height.
        :type args: int or float or iterable of Inner Radius, Outer Radius & Height.
        :Order: Inner Radius, Outer Radius, Height
        :e.g.: (2, 3, 5) or (2.0, 3.1, 5) or ([(2, 3.0, 5), {3.1, 4.2, 7}, [1, 2.2, 4.3]])
    ...
    def totalSurfaceArea(*args):
        ...
        Claculate the Total Surface Area of a Frustum with given Inner Radius, Outer Radius & Slant Height.
        :param args: Inner Radius, Outer Radius & Slant Height.
        :type args: int or float or iterable of Inner Radius, Outer Radius & Slant Height.
        :Order: Inner Radius, Outer Radius, Slant Height
        :e.g.: (2, 3, 5) or (2.0, 3.1, 5) or ([(2, 3.0, 5), {3.1, 4.2, 7}, [1, 2.2, 4.3]])
    ...
    def slantHeight(*args):
        ...
        Claculate the Slant Height of a Frustum with given Inner Radius, Outer Radius & Height.
        :param args: Inner Radius, Outer Radius & Height.
        :type args: int or float or iterable of Inner Radius, Outer Radius & Height.
        :Order: Inner Radius, Outer Radius, Height
        :e.g.: (2, 3, 5) or (2.0, 3.1, 5) or ([(2, 3.0, 5), {3.1, 4.2, 7}, [1, 2.2, 4.3]])
